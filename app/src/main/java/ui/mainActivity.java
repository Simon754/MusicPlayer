...
public class mainActivity extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    public static final String CTL_ACTION = "com.example.src.musicplay.CTL_ACTION";        //控制动作
    public static final String UPDATE_ACTION = "com.example.src.musicplay.UPDATE_ACTION";  //更新动作
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //获取控件
        moreMusic = findViewById(R.id.more);
        addMusicList = findViewById(R.id.new_musiclist);
        playlist = findViewById(R.id.music_playlist);
        how_play = findViewById(R.id.how_play);
        last_music = findViewById(R.id.last_music);
        play_music = findViewById(R.id.play_music);
        next_muisc = findViewById(R.id.next_music);
        //
    ...
    private void deleteMusic() {
        ...
        playListAdapter.isplaying = new HashMap<>();
